                    ...
                    {(() => {
                        if  (this.state.qID <= 1){
                            ...
                            <div className="item-b"><Button2 id="2" onClick={this.handleClick}>{this.state.content2}</Button2></div>
                                ...
                                <div className="item-b">  <EasybaseProvider ebconfig={ebconfig}><SavingData name={this.props.name} code={this.props.code}  influencePoints={this.state.influencePoints} sketchedImages={this.props.sketchedImages}/>
