    ...
    return (
      <div>
        ...
        <div className="filterEffekte">
          <b>Filter:</b>
          <div id="1" onClick={this.filterer}>
            threshold
          </div>
          <div id="2" onClick={this.filterer}>
            sepia
          </div>
          <div id="3" onClick={this.filterer}>
            goth tint
          </div>
          <div id="4" onClick={this.filterer}>
            posterize
          </div>
          <div id="5" onClick={this.filterer}>
            invert
          </div>
        </div>
      </div>
